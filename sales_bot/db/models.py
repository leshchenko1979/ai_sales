...
from sqlalchemy import create_engine, Column, Integer, String, DateTime, BigInteger, ForeignKey, Enum as SQLEnum
...
class Account(Base):
    ...
    def is_available(self) -> bool:
        ...
        return (
            ...
            self.daily_messages < MAX_DAILY_MESSAGES
        )
